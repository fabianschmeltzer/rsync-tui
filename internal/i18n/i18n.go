...
var catalogs = map[string]Catalog{
	"en": {
		...
		"wizard.review.save_help":          "[w] %s without running",
		...
		"profiles.help":                    "↑/↓ select • Enter run • e edit • d delete • Esc back",
		"profiles.delete.confirm":          "Delete profile '%s'? Press d to confirm or Esc to cancel.",
		"profiles.deleted":                 "Profile deleted.",
		"profiles.delete_error":            "Error: could not delete profile: %v",
		"wizard.action.save_only":          "save profile",
	...
	"de": {
		...
		"wizard.review.save_help":          "[w] %s ohne Ausführen",
		...
		"profiles.help":                    "↑/↓ auswählen • Enter ausführen • e bearbeiten • d löschen • Esc zurück",
		"profiles.delete.confirm":          "Profil '%s' löschen? d zum Bestätigen oder Esc zum Abbrechen.",
		"profiles.deleted":                 "Profil gelöscht.",
		"profiles.delete_error":            "Fehler: Profil konnte nicht gelöscht werden: %v",
		"wizard.action.save_only":          "Profil speichern",
